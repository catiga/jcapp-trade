...
//获取项目支付信息配置
ProjectGeneralConfig supp_config = JC.internal.call(ProjectGeneralConfig, 'project', '/incall/project_single_pt', [pid:pid, sc_type:'1000', sc_code:ct]);
...
other_param.put('pid', new BigInteger (pid));
