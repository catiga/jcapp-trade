package com.jeancoder.trade.internal.incall.reg
...
def callback = JC.internal.param('callback');
def dataformat = JC.internal.param('dataformat');
def order_type = JC.internal.param('order_type');
